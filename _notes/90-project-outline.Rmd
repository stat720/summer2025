...
## Learning objectives
Be able to identify a experiment design that is appropriate for answering a given research question and reflect on strengths and weaknesses.  
Be able to write out a statistical model that is appropriate for that design.
...
Submit a manuscript including an Introduction, Methods (including a clear and complete description of the statistical model), Expected results, and Discussions.
