...
t_comb <- data.frame(Source = c("Block", "Fungicide", "Fungicide(Block)", "Genotype", "Fung x Gen", "Pens(Block x Trt)\naka error",
                                "Total"),
...
[Follow along with this R script!](../scripts/06252025_splitplot2.Rmd)
