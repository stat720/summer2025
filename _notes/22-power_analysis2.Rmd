...
Likewise, a hypothesis test with an $\alpha=0.05$ will incorrectly reject the null hypothesis 5% of the times. 
...
b2.truth <- -.4 # true quadratic component 
...
- Treatment means: $\mu_{11}=2$, $\mu_{21}=2.4$, $\mu_{31}=2.6$, $\mu_{12}=2.6$, $\mu_{22}=3$, $\mu_{32}=3.2$. 
- Which means: $\mu_{1\cdot} - \mu_{2\cdot} = -0.4$, $\mu_{1\cdot} - \mu_{2\cdot} = -0.6$.

**Let's take a look at these competing designs:** 
...
df_crd <- df_crd %>%
  mutate(mu = case_when(oven_temp == "250" & recipe == "B" ~ 2, 
                        ...
                        oven_temp == "250" & recipe == "C" ~ 2.6, 
                        oven_temp == "400" & recipe == "C" ~ 3, 
                        oven_temp == "500" & recipe == "C" ~ 3.2))
...
hist(p_mu.1_mu.2, xlab = TeX("$\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$ estimated in the synthetic datasets under a CRD with 2 reps"))
hist(p_mu1._mu2.,  xlab = TeX("$\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$ estimated in the synthetic datasets under a CRD with 2 reps"))
```
...
df_crd <- df_crd %>%
  mutate(mu = case_when(oven_temp == "250" & recipe == "B" ~ 2, 
                        oven_temp == "400" & recipe == "B" ~ 2.4, 
                        oven_temp == "500" & recipe == "B" ~ 2.7, 
                        oven_temp == "250" & recipe == "C" ~ 2.6, 
                        oven_temp == "400" & recipe == "C" ~ 3, 
                        oven_temp == "500" & recipe == "C" ~ 3.3))
...
hist(p_mu.1_mu.2, xlab = TeX("$\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$ estimated in the synthetic datasets under a CRD with 3 reps"))

hist(p_mu1._mu2.,  xlab = TeX("$\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$ estimated in the synthetic datasets under a CRD with 3 reps"))
```
...
hist(p_mu.1_mu.2, xlab = TeX("$\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$ estimated in the synthetic datasets under a split-plot design with 2 reps"))
hist(p_mu1._mu2.,  xlab = TeX("$\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$ estimated in the synthetic datasets under a split-plot design with 2 reps"))
```
...
hist(p_mu.1_mu.2, xlab = TeX("$\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$ estimated in the synthetic datasets under a split-plot design with 3 reps"))
hist(p_mu1._mu2.,  xlab = TeX("$\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$ estimated in the synthetic datasets under a split-plot design with 3 reps"))
```
...
hist(p_mu.1_mu.2, xlab = TeX("$\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$ estimated in the synthetic datasets under a split-plot design with 2 reps and subsampling"))
hist(p_mu1._mu2.,  xlab = TeX("$\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$ estimated in the synthetic datasets under a split-plot design with 2 reps and subsampling"))
```
...
hist(p_mu.1_mu.2, xlab = TeX("$\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{\\cdot 1} - \\hat{\\mu}_{\\cdot 2}$ estimated in the synthetic datasets under a split-plot design with 3 reps and subsampling"))
hist(p_mu1._mu2.,  xlab = TeX("$\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$"),
     main = TeX("Histogram of the different $\\hat{\\mu}_{1 \\cdot} - \\hat{\\mu}_{2 \\cdot}$ estimated in the synthetic datasets under a split-plot design with 3 reps and subsampling"))
```
