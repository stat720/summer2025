...
## Building an ANOVA skeleton using topographical and design elements  
...
knitr::kables(
  list(
    knitr::kable(t_topo, caption = "Topographical"),
...
Check out [this R script](../scripts/06102025_rcbd.Rmd) to follow along!  
